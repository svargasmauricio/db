...
-- Copiando dados para a tabela agenda_wsd.agendaservico: ~15 rows (aproximadamente)
...
-- Copiando dados para a tabela agenda_wsd.confirmacaoagendaservico: ~8 rows (aproximadamente)
...
-- Copiando estrutura para tabela agenda_wsd.mensagem
CREATE TABLE IF NOT EXISTS `mensagem` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `usuario` varchar(45) NOT NULL DEFAULT '0',
  `conteudo` varchar(200) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Copiando dados para a tabela agenda_wsd.mensagem: ~0 rows (aproximadamente)
